                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h4 class="card-title text-primary mb-0">
                                        <i class="mdi mdi-account-tie"></i> Landlord List
                                    </h4>

                                    <a href="{{ route('manager.landLord_register') }}" class="btn btn-primary btn-sm">
                                        <i class="mdi mdi-account-plus"></i> Add New Landlord
                                    </a>
                                </div>
                                    ...
                                    <table id="landlordTable" class="table table-hover align-middle text-center">
                                        ...
                                        @forelse($landlords as $index => $landlord)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($landlord['created_at'])->format('Y-m-d') }}</td>
